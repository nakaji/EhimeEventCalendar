    ...
    $("#getEventInfo").click(function () {
        $.ajax({
            ...
            success: function (json) {
                ...
                $("#StartTime_Date").val(date.getFullYear() + "/" + ("0" + (date.getMonth() + 1)).slice(-2) + "/" + ("0" + date.getDate()).slice(-2));
                $("#StartTime_Hour").val(date.getHours());
                $("#StartTime_Minute").val(date.getMinutes());
                date = new Date(json.EndTime);
                $("#EndTime_Date").val(date.getFullYear() + "/" + ("0" + (date.getMonth() + 1)).slice(-2) + "/" + ("0" + date.getDate()).slice(-2));
